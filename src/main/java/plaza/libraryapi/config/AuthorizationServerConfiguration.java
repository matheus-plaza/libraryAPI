...
public class AuthorizationServerConfiguration {
    ...
    public TokenSettings tokenSettings(){
        return TokenSettings.builder()
                ...
                //accessToken: token utilizado nas requisições
                .refreshTokenTimeToLive(Duration.ofMinutes(90))
                //refreshToken: token para renovar o acessToken
                .build();
    }
    ...
    public AuthorizationServerSettings authorizationServerSettings(){
        return AuthorizationServerSettings.builder()
                ...
                // iformacoes do usuario do OPEN ID CONNECT
        ...
        return context -> {
            ...
            if(principal instanceof CustomAuthentication authentication){
                ...
                if(OAuth2TokenType.ACCESS_TOKEN.equals(tipoToken)){
                    ...
                    var list = authorities.stream().map(GrantedAuthority::getAuthority).toList();
